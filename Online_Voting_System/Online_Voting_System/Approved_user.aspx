    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True" DataSourceID="SqlDataSource2" AutoGenerateDeleteButton="True" CellPadding="1" DataKeyNames="Email">
                        <Columns>
